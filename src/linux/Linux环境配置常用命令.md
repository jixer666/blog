...
```bash
docker run --name mysql:8.0 -d -p 3306:3306 -v /lijunxi/docker/log:/var/log/mysql -v /liju
nxi/docker/data:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=jixer666mysql --restart=always mysql
```
